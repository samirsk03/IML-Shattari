! function(g) {
    ...
    g.fn.counterUp = function(e) {
        ...
        return this.each(function() {
            var h = g(this),
                f = {
                    time: g(this).data("counterup-time") || v.time,
                    delay: g(this).data("counterup-delay") || v.delay,
                    offset: g(this).data("counterup-offset") || v.offset,
                    beginAt: g(this).data("counterup-beginat") || v.beginAt,
                    context: g(this).data("counterup-context") || v.context
                };
            h.waypoint(function(e) {
                ! function() {
                    var e = [],
                        t = f.time / f.delay,
                        i = g(this).attr("data-num") ? g(this).attr("data-num") : h.text(),
                        a = /[0-9]+,[0-9]+/.test(i),
                        s = ((i = i.replace(/,/g, "")).split(".")[1] || []).length;
                    f.beginAt > i && (f.beginAt = i);
                    var n = /[0-9]+:[0-9]+:[0-9]+/.test(i);
                    if (n) {
                        var r = i.split(":"),
                            o = 1;
                        for (m = 0; 0 < r.length;) m += o * parseInt(r.pop(), 10), o *= 60
                    }
                    for (var l = t; l >= f.beginAt / i * t; l--) {
                        var d = parseFloat(i / t * l).toFixed(s);
                        if (n) {
                            d = parseInt(m / t * l);
                            var p = parseInt(d / 3600) % 24,
                                c = parseInt(d / 60) % 60,
                                u = parseInt(d % 60, 10);
                            d = (p < 10 ? "0" + p : p) + ":" + (c < 10 ? "0" + c : c) + ":" + (u < 10 ? "0" + u : u)
                        }
                        if (a)
                            for (;
                                /(\d+)(\d{3})/.test(d.toString());) d = d.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                        v.formatter && (d = v.formatter.call(this, d)), e.unshift(d)
                    }
                    h.data("counterup-nums", e), h.text(f.beginAt);
                    h.data("counterup-func", function() {
                        h.data("counterup-nums") ? (h.html(h.data("counterup-nums").shift()), h.data("counterup-nums").length ? setTimeout(h.data("counterup-func"), f.delay) : (h.data("counterup-nums", null), h.data("counterup-func", null), v.callback.call(this))) : v.callback.call(this)
...
function(e) {
    ...
    function u(e, t, i, a) {
        ...
        return s.className = "mfp-" + e, i && (s.innerHTML = i), a ? t && t.appendChild(s) : (s = p(s), t && s.appendTo(t)), s
    }

    function h(e, t) {
        m.ev.triggerHandler(i + e, t), m.st.callbacks && (e = e.charAt(0).toLowerCase() + e.slice(1), m.st.callbacks[e] && m.st.callbacks[e].apply(m, p.isArray(t) ? t : [t]))
    }

    function f(e) {
        return e === t && m.currTemplate.closeBtn || (m.currTemplate.closeBtn = p(m.st.closeMarkup.replace("%title%", m.st.tClose)), t = e), m.currTemplate.closeBtn
    }

    function n() {
        p.magnificPopup.instance || ((m = new e).init(), p.magnificPopup.instance = m)
    }
    var m, a, v, s, g, t, l = "Close",
        d = "BeforeClose",
        w = "MarkupParse",
        y = "Open",
        r = "Change",
    ...
    e.prototype = {
        ...
        init: function() {
            ...
            m.isLowIE = m.isIE8 = document.all && !document.addEventListener, m.isAndroid = /android/gi.test(e), m.isIOS = /iphone|ipad|ipod/gi.test(e), m.supportsTransition = function() {
                ...
                return !1
            }(), m.probablyMobile = m.isAndroid || m.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), v = p(document), m.popupsCache = {}
        },
        open: function(e) {
            var t;
            if (!1 === e.isObj) {
                ...
                for (t = 0; t < a.length; t++)
                    if ((i = a[t]).parsed && (i = i.el[0]), i === e.el[0]) {
                        m.index = t;
                        break
                    }
            } else m.items = p.isArray(e.items) ? e.items : [e.items], m.index = e.index || 0;
            if (!m.isOpen) {
                m.types = [], g = "", e.mainEl && e.mainEl.length ? m.ev = e.mainEl.eq(0) : m.ev = v, e.key ? (m.popupsCache[e.key] || (m.popupsCache[e.key] = {}), m.currTemplate = m.popupsCache[e.key]) : m.currTemplate = {}, m.st = p.extend(!0, {}, p.magnificPopup.defaults, e), m.fixedContentPos = "auto" === m.st.fixedContentPos ? !m.probablyMobile : m.st.fixedContentPos, m.st.modal && (m.st.closeOnContentClick = !1, m.st.closeOnBgClick = !1, m.st.showCloseBtn = !1, m.st.enableEscapeKey = !1), m.bgOverlay || (m.bgOverlay = u("bg").on("click" + b, function() {
                    m.close()
                ...
                var s = p.magnificPopup.modules;
                for (t = 0; t < s.length; t++) {
                    var n = s[t];
                    n = n.charAt(0).toUpperCase() + n.slice(1), m["init" + n].call(m)
                }
                h("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (c(w, function(e, t, i, a) {
                    ...
                    height: v.height(),
                    position: "absolute"
                }), m.st.enableEscapeKey && v.on("keyup" + b, function(e) {
                ...
                m.fixedContentPos && (m.isIE7 ? p("body, html").css("overflow", "hidden") : o.overflow = "hidden");
                var d = m.st.mainClass;
                return m.isIE7 && (d += " mfp-ie7"), d && m._addClassToMFP(d), m.updateItemHTML(), h("BuildControls"), p("html").css(o), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || p(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function() {
                    m.content ? (m._addClassToMFP(x), m._setFocus()) : m.bgOverlay.addClass(x), v.on("focusin" + b, m._onFocusIn)
                }, 16), m.isOpen = !0, m.updateSize(r), h(y), e
            }
            m.updateItemHTML()
        },
        close: function() {
            m.isOpen && (h(d), m.isOpen = !1, m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(o), setTimeout(function() {
                m._close()
        ...
        updateItemHTML: function() {
            ...
            if (h("BeforeChange", [m.currItem ? m.currItem.type : "", t]), m.currItem = e, !m.currTemplate[t]) {
                ...
                h("FirstMarkupParse", i), m.currTemplate[t] = !i || p(i)
            }
            s && s !== e.type && m.container.removeClass("mfp-" + s + "-holder");
            var a = m["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, m.currTemplate[t]);
            m.appendContent(a, t), e.preloaded = !0, h(r, e), s = e.type, m.container.prepend(m.contentContainer), h("AfterChange")
        },
        ...
        parseEl: function(e) {
            ...
            if ((i = i.tagName ? {
                ...
                for (var a = m.types, s = 0; s < a.length; s++)
        ...
        _openClick: function(e, t, i) {
            if ((void 0 !== i.midClick ? i.midClick : p.magnificPopup.defaults.midClick) || !(2 === e.which || e.ctrlKey || e.metaKey || e.altKey || e.shiftKey)) {
                var a = void 0 !== i.disableOn ? i.disableOn : p.magnificPopup.defaults.disableOn;
                if (a)
                    if (p.isFunction(a)) {
                        if (!a.call(m)) return !0
                    } else if (T.width() < a) return !0;
                e.type && (e.preventDefault(), m.isOpen && e.stopPropagation()), i.el = p(e.mfpEl), i.delegate && (i.items = t.find(i.delegate)), m.open(i)
            }
        },
        updateStatus: function(e, t) {
            if (m.preloader) {
                a !== e && m.container.removeClass("mfp-s-" + a), t || "loading" !== e || (t = m.st.tLoading);
                var i = {
                    status: e,
                    text: t
                };
        ...
        _checkIfClose: function(e) {
            if (!p(e).hasClass(C)) {
                ...
                if (t && i) return !0;
                if (!m.content || p(e).hasClass("mfp-close") || m.preloader && e === m.preloader[0]) return !0;
                if (e === m.content[0] || p.contains(m.content[0], e)) {
                    if (t) return !0
        ...
        _onFocusIn: function(e) {
            return e.target === m.wrap[0] || p.contains(m.wrap[0], e.target) ? void 0 : (m._setFocus(), !1)
        },
        _parseMarkup: function(s, e, t) {
            var n;
            t.data && (e = p.extend(t.data, e)), h(w, [s, e, t]), p.each(e, function(e, t) {
                if (void 0 === t || !1 === t) return !0;
                if (1 < (n = e.split("_")).length) {
                    var i = s.find(b + "-" + n[0]);
                    if (0 < i.length) {
                        var a = n[1];
                        "replaceWith" === a ? i[0] !== t[0] && i.replaceWith(t) : "img" === a ? i.is("img") ? i.attr("src", t) : i.replaceWith(p("<img>").attr("src", t).attr("class", i.attr("class"))) : i.attr(n[1], t)
                    }
        ...
        modules: [],
        open: function(e, t) {
            return n(), (e = e ? p.extend(!0, {}, e) : {}).isObj = !0, e.index = t || 0, this.instance.open(e)
        },
        close: function() {
        ...
        if ("string" == typeof e)
            if ("open" === e) {
                var i, a = E ? t.data("magnificPopup") : t[0].magnificPopup,
                    s = parseInt(arguments[1], 10) || 0;
                i = a.items ? a.items[s] : (i = t, a.delegate && (i = i.find(a.delegate)), i.eq(s)), m._openClick({
                    mfpEl: i
                }, t, a)
            } else m.isOpen && m[e].apply(m, Array.prototype.slice.call(arguments, 1));
        else e = p.extend(!0, {}, e), E ? t.data("magnificPopup", e) : t[0].magnificPopup = e, m.addGroup(t, e);
        return t
    };

    function S() {
        P && (k.after(P.addClass(M)).detach(), P = null)
    }
    var M, k, P, z = "inline";
            ...
            getInline: function(e, t) {
                if (S(), e.src) {
                    ...
                    if (a.length) {
                        ...
                        s && s.tagName && (k || (M = i.hiddenClass, k = u(M), M = "mfp-" + M), P = a.after(k).detach().removeClass(M)), m.updateStatus("ready")
                    } else m.updateStatus("error", i.tNotFound), a = p("<div>");
    ...
    p.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                m.types.push(A), $ = m.st.ajax.cursor, c(l + "." + A, L), c("BeforeChange." + A, L)
            },
            getAjax: function(s) {
                $ && p(document.body).addClass($), m.updateStatus("loading");
                var e = p.extend({
                    url: s.src,
                    success: function(e, t, i) {
                        ...
                        h("ParseAjax", a), m.appendContent(p(a.data), A), s.finished = !0, I(), m._setFocus(), setTimeout(function() {
                            m.wrap.addClass(x)
    ...
    p.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var e = m.st.image,
                    t = ".image";
                m.types.push("image"), c(y + t, function() {
                    "image" === m.currItem.type && e.cursor && p(document.body).addClass(e.cursor)
                }), c(l + t, function() {
                    e.cursor && p(document.body).removeClass(e.cursor), T.off("resize" + b)
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, O && clearInterval(O), e.isCheckingImgSize = !1, h("ImageHasSize", e), e.imgHidden && (m.content && m.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    s = function(e) {
                        O && clearInterval(O), O = setInterval(function() {
                            return 0 < a.naturalWidth ? void m._onImageHasSize(t) : (200 < i && clearInterval(O), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                        }, e)
                    };
                s(1)
            },
            getImage: function(e, t) {
                var i = 0,
                    a = function() {
                        e && (e.img[0].complete ? (e.img.off(".mfploader"), e === m.currItem && (m._onImageHasSize(e), m.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, h("ImageLoadComplete")) : ++i < 200 ? setTimeout(a, 100) : s())
                    },
                    s = function() {
                ...
                if (r.length) {
                    ...
                    o.className = "mfp-img", e.el && e.el.find("img").length && (o.alt = e.el.find("img").attr("alt")), e.img = p(o).on("load.mfploader", a).on("error.mfploader", s), o.src = e.src, r.is("img") && (e.img = e.img.clone()), 0 < (o = e.img[0]).naturalWidth ? e.hasSize = !0 : o.width || (e.hasSize = !1)
                }
                return m._parseMarkup(t, {
                    title: function(e) {
                        ...
                        if (t) {
                            if (p.isFunction(t)) return t.call(m, e);
                            if (e.el) return e.el.attr(t) || ""
                        }
                        return ""
                    }(e),
                    img_replaceWith: e.img
                }, e), m.resizeImage(), e.hasSize ? (O && clearInterval(O), e.loadError ? (t.addClass("mfp-loading"), m.updateStatus("error", n.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), m.findImageSize(e))), t
            }
        }
    });
    var D;
    p.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && m.supportsTransition) {
                    ...
                    c("BuildControls" + t, function() {
                        if (m._allowZoom()) {
                            if (clearTimeout(s), m.content.css("visibility", "hidden"), !(e = m._getItemToZoom())) return void a();
                        ...
                        m._allowZoom() && (a(), r && r.remove(), e = null)
                    })
                }
            },
            _allowZoom: function() {
            ...
            _getOffset: function(e) {
                ...
                i.top -= p(window).scrollTop() - a;
                var n = {
                    width: t.width(),
                    height: (E ? t.innerHeight() : t[0].offsetHeight) - s - a
                };
                return void 0 === D && (D = void 0 !== document.createElement("p").style.MozTransform), D ? n["-moz-transform"] = n.transform = "translate(" + i.left + "px," + i.top + "px)" : (n.left = i.left, n.top = i.top), n
            }
        }
    });
    ...
    function H(e) {
        if (m.currTemplate[B]) {
            var t = m.currTemplate[B].find("iframe");
            t.length && (e || (t[0].src = "//about:blank"), m.isIE8 && t.css("display", e ? "block" : "none"))
        }
    }
    var B = "iframe";
    p.magnificPopup.registerModule(B, {
        options: {
        ...
        proto: {
            initIframe: function() {
                m.types.push(B), c("BeforeChange", function(e, t, i) {
                    t !== i && (t === B ? H() : i === B && H(!0))
                }), c(l + "." + B, function() {
                    H()
                })
            ...
            getIframe: function(e, t) {
                var i = e.src,
                    a = m.st.iframe;
                p.each(a.patterns, function() {
                    return -1 < i.indexOf(this.index) ? (this.id && (i = "string" == typeof this.id ? i.substr(i.lastIndexOf(this.id) + this.id.length, i.length) : this.id.call(this, i)), i = this.src.replace("%id%", i), !1) : void 0
                });
                var s = {};
                return a.srcAction && (s[a.srcAction] = i), m._parseMarkup(t, s, e), m.updateStatus("ready"), t
            }
        }
    });
    ...
    p.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = m.st.gallery,
                    e = ".mfp-gallery";
                return m.direction = !0, !(!n || !n.enabled) && (g += " mfp-gallery", c(y + e, function() {
                    ...
                    t.text && (t.text = G(t.text, m.currItem.index, m.items.length))
                }), c(w + e, function(e, t, i, a) {
                    var s = m.items.length;
                    i.counter = 1 < s ? G(n.tCounter, a.index, s) : ""
                }), c("BuildControls" + e, function() {
                    if (1 < m.items.length && n.arrows && !m.arrowLeft) {
                        var e = n.arrowMarkup,
                            t = m.arrowLeft = p(e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(C),
                            i = m.arrowRight = p(e.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(C);
                        t.click(function() {
                            m.prev()
                        }), i.click(function() {
                            m.next()
            ...
            preloadNearbyImages: function() {
                var e, t = m.st.gallery.preload,
                    ...
                    a = Math.min(t[1], m.items.length);
                for (e = 1; e <= (m.direction ? a : i); e++) m._preloadItem(m.index + e);
                for (e = 1; e <= (m.direction ? i : a); e++) m._preloadItem(m.index - e)
            },
            _preloadItem: function(e) {
                if (e = N(e), !m.items[e].preloaded) {
                    var t = m.items[e];
                    t.parsed || (t = m.parseEl(e)), h("LazyLoad", t), "image" === t.type && (t.img = p('<img class="mfp-img" />').on("load.mfploader", function() {
                        t.hasSize = !0
    ...
    var F = "retina";
    p.magnificPopup.registerModule(F, {
        options: {
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var i = m.st.retina,
                        a = i.ratio;
                    1 < (a = isNaN(a) ? a() : a) && (c("ImageHasSize." + F, function(e, t) {
                        t.img.css({
                            "max-width": t.img[0].naturalWidth / a,
                            width: "100%"
                        })
                    }), c("ElementParse." + F, function(e, t) {
...
function(e, t) {
        ...
        if (e)
            if ("string" == typeof e) {
                ...
                if (0 <= r.indexOf("<") && 0 <= r.indexOf(">")) {
                    var o = "div";
                    for (0 === r.indexOf("<li") && (o = "ul"), 0 === r.indexOf("<tr") && (o = "tbody"), 0 !== r.indexOf("<td") && 0 !== r.indexOf("<th") || (o = "tr"), 0 === r.indexOf("<tbody") && (o = "table"), 0 === r.indexOf("<option") && (o = "select"), (n = m.createElement(o)).innerHTML = r, a = 0; a < n.childNodes.length; a += 1) i.push(n.childNodes[a])
                } else
                    for (s = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || m).querySelectorAll(e.trim()) : [m.getElementById(e.trim().split("#")[1])], a = 0; a < s.length; a += 1) s[a] && i.push(s[a])
    ...
    var t = {
        ...
        on: function() {
            ...
            function s(e) {
                ...
                if (t) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), L(t).is(n)) r.apply(t, i);
                        ...
                        for (var a = L(t).parents(), s = 0; s < a.length; s += 1) L(a[s]).is(n) && r.apply(a[s], i)
                }
            }
            ...
            for (var l, d = i.split(" "), p = 0; p < this.length; p += 1) {
                var c = this[p];
                if (n)
        ...
        off: function() {
            ...
            for (var r = i.split(" "), o = 0; o < r.length; o += 1)
                for (var l = r[o], d = 0; d < this.length; d += 1) {
                    var p = this[d],
                        c = void 0;
                    if (!a && p.dom7Listeners ? c = p.dom7Listeners[l] : a && p.dom7LiveListeners && (c = p.dom7LiveListeners[l]), c && c.length)
                        for (var u = c.length - 1; 0 <= u; --u) {
                            var h = c[u];
                            (s && h.listener === s || s && h.listener && h.listener.dom7proxy && h.listener.dom7proxy === s || !s) && (p.removeEventListener(l, h.proxyListener, n), c.splice(u, 1))
                        }
                }
            return this
        },
        ...
        transitionEnd: function(t) {
            ...
            if (t)
                for (i = 0; i < a.length; i += 1) s.on(a[i], n);
            return this
        },
        ...
        parents: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var a = this[i].parentNode; a;) e && !L(a).is(e) || t.push(a), a = a.parentNode;
            return L(n(t))
        },
        closest: function(e) {
            var t = this;
        ...
        children: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var a = this[i].childNodes, s = 0; s < a.length; s += 1) e ? 1 === a[s].nodeType && L(a[s]).is(e) && t.push(a[s]) : 1 === a[s].nodeType && t.push(a[s]);
            return new l(n(t))
        },
        remove: function() {
    ...
    var i, a, s, r, ee = {
            ...
            getTranslate: function(e, t) {
                ...
                return J.WebKitCSSMatrix ? (6 < (a = n.transform || n.webkitTransform).split(",").length && (a = a.split(", ").map(function(e) {
                    return e.replace(",", ".")
                }).join(", ")), s = new J.WebKitCSSMatrix("none" === a ? "" : a)) : i = (s = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (a = J.WebKitCSSMatrix ? s.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (a = J.WebKitCSSMatrix ? s.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), a || 0
            },
        ...
        te = (s = m.createElement("div"), {
            ...
            transforms3d: J.Modernizr && !0 === J.Modernizr.csstransforms3d || ("webkitPerspective" in (i = s.style) || "MozPerspective" in i || "OPerspective" in i || "MsPerspective" in i || "perspective" in i),
            flexbox: function() {
        ...
        $ = {
            ...
            isSafari: 0 <= (r = J.navigator.userAgent.toLowerCase()).indexOf("safari") && r.indexOf("chrome") < 0 && r.indexOf("android") < 0,
    ...
    e.prototype.on = function(e, t, i) {
        ...
        for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
        var i, a, s, n = this;
        return n.eventsListeners && (s = "string" == typeof e[0] || Array.isArray(e[0]) ? (i = e[0], a = e.slice(1, e.length), n) : (i = e[0].events, a = e[0].data, e[0].context || n), (Array.isArray(i) ? i : i.split(" ")).forEach(function(e) {
    ...
    var d = {
            updateSize: function() {
                var e, t, i = this,
                    a = i.$el;
                e = void 0 !== i.params.width ? i.params.width : a[0].clientWidth, t = void 0 !== i.params.height ? i.params.height : a[0].clientHeight, 0 === e && i.isHorizontal() || 0 === t && i.isVertical() || (e = e - parseInt(a.css("padding-left"), 10) - parseInt(a.css("padding-right"), 10), t = t - parseInt(a.css("padding-top"), 10) - parseInt(a.css("padding-bottom"), 10), ee.extend(i, {
                    width: e,
                    height: t,
            ...
            updateSlides: function() {
                ...
                if (void 0 !== a) {
                    var x, C;
                    "string" == typeof g && 0 <= g.indexOf("%") && (g = parseFloat(g.replace("%", "")) / 100 * a), e.virtualSize = -g, s ? l.css({
                        marginLeft: "",
                        marginTop: ""
                    }) : l.css({
                        marginRight: "",
                    ...
                    for (var E, T = t.slidesPerColumn, S = x / T, M = Math.floor(d / t.slidesPerColumn), k = 0; k < d; k += 1) {
                        C = 0;
                        var P = l.eq(k);
                        if (1 < t.slidesPerColumn) {
                            var z = void 0,
                                I = void 0,
                                L = void 0;
                            "column" === t.slidesPerColumnFill ? (L = k - (I = Math.floor(k / T)) * T, (M < I || I === M && L === T - 1) && T <= (L += 1) && (L = 0, I += 1), z = I + L * x / T, P.css({
                                "-webkit-box-ordinal-group": z,
                                "-moz-box-ordinal-group": z,
                                "-ms-flex-order": z,
                                "-webkit-order": z,
                                order: z
                            })) : I = k - (L = Math.floor(k / S)) * S, P.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== L && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", I).attr("data-swiper-row", L)
                        }
                        if ("none" !== P.css("display")) {
                            if ("auto" === t.slidesPerView) {
                                var $ = J.getComputedStyle(P[0], null),
                                    A = P[0].style.transform,
                                    O = P[0].style.webkitTransform;
                                if (A && (P[0].style.transform = "none"), O && (P[0].style.webkitTransform = "none"), t.roundLengths) C = e.isHorizontal() ? P.outerWidth(!0) : P.outerHeight(!0);
                                else if (e.isHorizontal()) {
                                    var D = parseFloat($.getPropertyValue("width")),
                                        H = parseFloat($.getPropertyValue("padding-left")),
                                        B = parseFloat($.getPropertyValue("padding-right")),
                                        N = parseFloat($.getPropertyValue("margin-left")),
                                        G = parseFloat($.getPropertyValue("margin-right")),
                                        F = $.getPropertyValue("box-sizing");
                                    C = F && "border-box" === F ? D + N + G : D + H + B + N + G
                                } else {
                                    var V = parseFloat($.getPropertyValue("height")),
                                    ...
                                    C = R && "border-box" === R ? V + W + q : V + Y + X + W + q
                                }
                                A && (P[0].style.transform = A), O && (P[0].style.webkitTransform = O), t.roundLengths && (C = Math.floor(C))
                            } else C = (a - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (C = Math.floor(C)), l[k] && (e.isHorizontal() ? l[k].style.width = C + "px" : l[k].style.height = C + "px");
                            l[k] && (l[k].swiperSlideSize = C), u.push(C), t.centeredSlides ? (w = w + C / 2 + y / 2 + g, 0 === y && 0 !== k && (w = w - a / 2 - g), 0 === k && (w = w - a / 2 - g), Math.abs(w) < .001 && (w = 0), t.roundLengths && (w = Math.floor(w)), b % t.slidesPerGroup == 0 && p.push(w), c.push(w)) : (t.roundLengths && (w = Math.floor(w)), b % t.slidesPerGroup == 0 && p.push(w), c.push(w), w = w + C + g), e.virtualSize += C + g, y = C, b += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, a) + f, s && n && ("slide" === t.effect || "coverflow" === t.effect) && i.css({
                        ...
                        })), 1 < t.slidesPerColumn && (e.virtualSize = (C + t.spaceBetween) * x, e.virtualSize = Math.ceil(e.virtualSize / t.slidesPerColumn) - t.spaceBetween, e.isHorizontal() ? i.css({
                            width: e.virtualSize + t.spaceBetween + "px"
                        }) : i.css({
                            height: e.virtualSize + t.spaceBetween + "px"
                        }), t.centeredSlides)) {
                        ...
                        for (var j = 0; j < p.length; j += 1) {
                            var _ = p[j];
                            t.roundLengths && (_ = Math.floor(_)), p[j] < e.virtualSize + p[0] && E.push(_)
                        }
                        p = E
                    }
                    if (!t.centeredSlides) {
                        ...
                        for (var K = 0; K < p.length; K += 1) {
                            var U = p[K];
                            t.roundLengths && (U = Math.floor(U)), p[K] <= e.virtualSize - a && E.push(U)
                        }
                        p = E, 1 < Math.floor(e.virtualSize - a) - Math.floor(p[p.length - 1]) && p.push(e.virtualSize - a)
                    }
                    ...
                    ee.extend(e, {
                        ...
                        slidesGrid: c,
                        slidesSizesGrid: u
                    }), d !== o && e.emit("slidesLengthChange"), p.length !== m && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), c.length !== v && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
                }
            },
            ...
            updateSlidesProgress: function(e) {
                ...
                if (0 !== a.length) {
                    ...
                    var n = -e;
                    s && (n = e), a.removeClass(i.slideVisibleClass), t.visibleSlidesIndexes = [], t.visibleSlides = [];
                    for (var r = 0; r < a.length; r += 1) {
                        ...
                        if (i.watchSlidesVisibility) {
                            ...
                            (0 <= d && d < t.size || 0 < p && p <= t.size || d <= 0 && p >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(r), a.eq(r).addClass(i.slideVisibleClass))
                        }
                        o.progress = s ? -l : l
                    }
            ...
            updateProgress: function(e) {
                ...
                var t = this,
                    ...
                    o = n,
                    l = r;
                r = 0 == a ? n = !(s = 0) : (n = (s = (e - t.minTranslate()) / a) <= 0, 1 <= s), ee.extend(t, {
                    progress: s,
                    isBeginning: n,
                    isEnd: r
            ...
            updateActiveIndex: function(e) {
                ...
                if ((t = 0 <= n.indexOf(a) ? n.indexOf(a) : Math.floor(p / r.slidesPerGroup)) >= n.length && (t = n.length - 1), p !== o) {
            ...
            updateClickedSlide: function(e) {
                var t = this,
                    i = t.params,
                    a = L(e.target).closest("." + i.slideClass)[0],
                    s = !1;
                if (a)
                    for (var n = 0; n < t.slides.length; n += 1) t.slides[n] === a && (s = !0);
                if (!a || !s) return t.clickedSlide = void 0, void(t.clickedIndex = void 0);
                t.clickedSlide = a, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(L(a).attr("data-swiper-slide-index"), 10) : t.clickedIndex = L(a).index(), i.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
            }
        },
        p = {
            ...
            setTranslate: function(e, t) {
                var i = this,
                    ...
                    o = 0,
                    l = 0;
                i.isHorizontal() ? o = a ? -e : e : l = e, s.roundLengths && (o = Math.floor(o), l = Math.floor(l)), s.virtualTranslate || (te.transforms3d ? n.transform("translate3d(" + o + "px, " + l + "px, 0px)") : n.transform("translate(" + o + "px, " + l + "px)")), i.previousTranslate = i.translate, i.translate = i.isHorizontal() ? o : l;
        ...
        c = {
            ...
            slidePrev: function(e, t, i) {
                ...
                var p, c = d(l ? a.translate : -a.translate),
                    u = r.map(function(e) {
                        return d(e)
                    }),
                    h = (o.map(function(e) {
            ...
            slideToClickedSlide: function() {
                ...
                if (i.loop) {
                    ...
                    e = parseInt(L(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? n < t.loopedSlides - s / 2 || n > t.slides.length - t.loopedSlides + s / 2 ? (t.loopFix(), n = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), ee.nextTick(function() {
                        t.slideTo(n)
                    })) : t.slideTo(n) : n > t.slides.length - s ? (t.loopFix(), n = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), ee.nextTick(function() {
                        t.slideTo(n)
                    })) : t.slideTo(n)
                } else t.slideTo(n)
            }
        ...
        u = {
            loopCreate: function() {
                ...
                if (e.loopFillGroupWithBlank) {
                    ...
                    if (i !== e.slidesPerGroup) {
                        for (var n = 0; n < i; n += 1) {
                            var r = L(m.createElement("div")).addClass(e.slideClass + " " + e.slideBlankClass);
                            t.append(r)
                        }
            ...
            loopFix: function() {
                ...
                a < n ? (e = s.length - 3 * n + a, e += n, t.slideTo(e, 0, !1, !0) && 0 != p && t.setTranslate((d ? -t.translate : t.translate) - p)) : ("auto" === i.slidesPerView && 2 * n <= a || a >= s.length - n) && (e = -s.length + a + n, e += n, t.slideTo(e, 0, !1, !0) && 0 != p && t.setTranslate((d ? -t.translate : t.translate) - p)), t.allowSlidePrev = r, t.allowSlideNext = o
            },
        ...
        f = {
            ...
            prependSlide: function(e) {
                ...
                i.loop && t.loopCreate(), i.observer && te.observer || t.update(), t.slideTo(n, 0, !1)
            },
            addSlide: function(e, t) {
                ...
                if (e <= 0) i.prependSlide(t);
                    ...
                    for (var u = 0; u < l.length; u += 1) a.append(l[u]);
        ...
        v = function() {
            ...
            if (i && (t.os = "windows", t.osVersion = i[2], t.windows = !0), a && !i && (t.os = "android", t.osVersion = a[2], t.android = !0, t.androidChrome = 0 <= e.toLowerCase().indexOf("chrome")), (s || r || n) && (t.os = "ios", t.ios = !0), r && !n && (t.osVersion = r[2].replace(/_/g, "."), t.iphone = !0), s && (t.osVersion = s[2].replace(/_/g, "."), t.ipad = !0), n && (t.osVersion = n[3] ? n[3].replace(/_/g, ".") : null, t.iphone = !0), t.ios && t.osVersion && 0 <= e.indexOf("Version/") && "10" === t.osVersion.split(".")[0] && (t.osVersion = e.toLowerCase().split("version/")[1].split(" ")[0]), t.desktop = !(t.os || t.android || t.webView), t.webView = (r || s || n) && e.match(/.*AppleWebKit(?!.*Safari)/i), t.os && "ios" === t.os) {
                ...
                t.minimalUi = !t.webView && (n || r) && (7 == +o[0] ? 1 <= +o[1] : 7 < +o[0]) && l && 0 <= l.getAttribute("content").indexOf("minimal-ui")
            }
    ...
    var w = {
        ...
        y = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = function(e) {
                        ...
                        if (!t.animating || !a.preventInteractionOnTransition) {
                            var n = e;
                            if (n.originalEvent && (n = n.originalEvent), i.isTouchEvent = "touchstart" === n.type, (i.isTouchEvent || !("which" in n) || 3 !== n.which) && !(!i.isTouchEvent && "button" in n && 0 < n.button || i.isTouched && i.isMoved))
                                if (a.noSwiping && L(n.target).closest(a.noSwipingSelector ? a.noSwipingSelector : "." + a.noSwipingClass)[0]) t.allowClick = !0;
                                else if (!a.swipeHandler || L(n).closest(a.swipeHandler)[0]) {
                                ...
                                if (!l || !(r <= d || r >= J.screen.width - d)) {
                                    if (ee.extend(i, {
                                            ...
                                            isScrolling: void 0,
                                            startMoving: void 0
                                        }), s.startX = r, s.startY = o, i.touchStartTime = ee.now(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, 0 < a.threshold && (i.allowThresholdMove = !1), "touchstart" !== n.type) {
                                        var p = !0;
                                        L(n.target).is(i.formElements) && (p = !1), m.activeElement && L(m.activeElement).is(i.formElements) && m.activeElement !== n.target && m.activeElement.blur();
                                        var c = p && t.allowTouchMove && a.touchStartPreventDefault;
                        ...
                        if (r.originalEvent && (r = r.originalEvent), i.isTouched) {
                            if (!i.isTouchEvent || "mousemove" !== r.type) {
                                ...
                                if (i.isTouchEvent && m.activeElement && r.target === m.activeElement && L(r.target).is(i.formElements)) return i.isMoved = !0, void(t.allowClick = !1);
                                if (i.allowTouchCallbacks && t.emit("touchMove", r), !(r.targetTouches && 1 < r.targetTouches.length)) {
                                    s.currentX = o, s.currentY = l;
                                    var d, p = s.currentX - s.startX,
                                        c = s.currentY - s.startY;
                                    if (!(t.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(c, 2)) < t.params.threshold))
                                        if (void 0 === i.isScrolling && (t.isHorizontal() && s.currentY === s.startY || t.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : 25 <= p * p + c * c && (d = 180 * Math.atan2(Math.abs(c), Math.abs(p)) / Math.PI, i.isScrolling = t.isHorizontal() ? d > a.touchAngle : 90 - d > a.touchAngle)), i.isScrolling && t.emit("touchMoveOpposite", r), void 0 === i.startMoving && (s.currentX === s.startX && s.currentY === s.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;
                        ...
                        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap", d), u < 300 && 300 < c - i.lastClickTime && (i.clickTimeout && clearTimeout(i.clickTimeout), i.clickTimeout = ee.nextTick(function() {
                                t && !t.destroyed && t.emit("click", d)
                            }, 300)), u < 300 && c - i.lastClickTime < 300 && (i.clickTimeout && clearTimeout(i.clickTimeout), t.emit("doubleTap", d))), i.lastClickTime = ee.now(), ee.nextTick(function() {
                                t.destroyed || (t.allowClick = !0)
                            }), !i.isTouched || !i.isMoved || !t.swipeDirection || 0 === s.diff || i.currentTranslate === i.startTranslate) return i.isTouched = !1, i.isMoved = !1, void(i.startMoving = !1);
                        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, p = a.followFinger ? n ? t.translate : -t.translate : -i.currentTranslate, a.freeMode) {
                            ...
                            if (a.freeModeMomentum) {
                                if (1 < i.velocities.length) {
                                    var h = i.velocities.pop(),
                                        ...
                                        v = h.time - f.time;
                                    t.velocity = m / v, t.velocity /= 2, Math.abs(t.velocity) < a.freeModeMinimumVelocity && (t.velocity = 0), (150 < v || 300 < ee.now() - h.time) && (t.velocity = 0)
                                } else t.velocity = 0;
                                ...
                                if (y < t.maxTranslate()) a.freeModeMomentumBounce ? (y + t.maxTranslate() < -E && (y = t.maxTranslate() - E), b = t.maxTranslate(), C = !0, i.allowMomentumBounce = !0) : y = t.maxTranslate(), a.loop && a.centeredSlides && (x = !0);
                                else if (y > t.minTranslate()) a.freeModeMomentumBounce ? (y - t.minTranslate() > E && (y = t.minTranslate() + E), b = t.minTranslate(), C = !0, i.allowMomentumBounce = !0) : y = t.minTranslate(), a.loop && a.centeredSlides && (x = !0);
                                ...
                                if (x && t.once("transitionEnd", function() {
                                        t.loopFix()
                                    }), 0 !== t.velocity) g = n ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity);
                                else if (a.freeModeSticky) return void t.slideToClosest();
                                a.freeModeMomentumBounce && C ? (t.updateProgress(b), t.setTransition(g), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, r.transitionEnd(function() {
                    ...
                    if (te.touch || !te.pointerEvents && !te.prefixedPointerEvents) {
                        if (te.touch) {
                            ...
                            n.addEventListener(i.start, e.onTouchStart, o), n.addEventListener(i.move, e.onTouchMove, te.passiveListener ? {
                                passive: !1,
                                capture: r
                            } : r), n.addEventListener(i.end, e.onTouchEnd, o)
                        }(t.simulateTouch && !v.ios && !v.android || t.simulateTouch && !te.touch && v.ios) && (n.addEventListener("mousedown", e.onTouchStart, !1), m.addEventListener("mousemove", e.onTouchMove, r), m.addEventListener("mouseup", e.onTouchEnd, !1))
                    } else n.addEventListener(i.start, e.onTouchStart, !1), m.addEventListener(i.move, e.onTouchMove, r), m.addEventListener(i.end, e.onTouchEnd, !1);
                    (t.preventClicks || t.preventClicksPropagation) && n.addEventListener("click", e.onClick, !0), e.on(v.ios || v.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", g, !0)
                },
                detachEvents: function() {
                    ...
                    if (te.touch || !te.pointerEvents && !te.prefixedPointerEvents) {
                        ...
                        }(t.simulateTouch && !v.ios && !v.android || t.simulateTouch && !te.touch && v.ios) && (n.removeEventListener("mousedown", e.onTouchStart, !1), m.removeEventListener("mousemove", e.onTouchMove, r), m.removeEventListener("mouseup", e.onTouchEnd, !1))
                    } else n.removeEventListener(i.start, e.onTouchStart, !1), m.removeEventListener(i.move, e.onTouchMove, r), m.removeEventListener(i.end, e.onTouchEnd, !1);
                    (t.preventClicks || t.preventClicksPropagation) && n.removeEventListener("click", e.onClick, !0), e.off(v.ios || v.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", g)
                }
            },
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    if (n && (!n || 0 !== Object.keys(n).length)) {
                        ...
                        if (r && e.currentBreakpoint !== r) {
                            ...
                            }), e.currentBreakpoint = r, p && i && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - a + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
                        }
                    }
                },
            ...
            images: {
                loadImage: function(e, t, i, a, s, n) {
                    ...
                    function o() {
                        n && n()
                    }(!e.complete || !s) && t ? ((r = new J.Image).onload = o, r.onerror = o, a && (r.sizes = a), i && (r.srcset = i), t && (r.src = t)) : o()
                },
        ...
        x = function(c) {
            function u() {
                ...
                s = (s = 1 === t.length && t[0].constructor && t[0].constructor === Object ? t[0] : (e = t[0], t[1])) || {}, s = ee.extend({}, s), e && !s.el && (s.el = e), c.call(this, s), Object.keys(y).forEach(function(t) {
                ...
                var a = ee.extend({}, w);
                n.useModulesParams(a), n.params = ee.extend({}, a, b, s), n.originalParams = ee.extend({}, n.params), n.passedParams = ee.extend({}, s);
                ...
                if (e = r[0]) {
                    ...
                    var l, d, p = r.children("." + n.params.wrapperClass);
                    return ee.extend(n, {
                        $el: r,
                        el: e,
                        $wrapperEl: p,
                        ...
                        touchEvents: (l = ["touchstart", "touchmove", "touchend"], d = ["mousedown", "mousemove", "mouseup"], te.pointerEvents ? d = ["pointerdown", "pointermove", "pointerup"] : te.prefixedPointerEvents && (d = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), n.touchEventsTouch = {
                            start: l[0],
                            move: l[1],
                            end: l[2]
            ...
            return ((u.prototype = Object.create(c && c.prototype)).constructor = u).prototype.slidesPerViewDynamic = function() {
                ...
                if (t.centeredSlides) {
                    ...
                    for (var p = n - 1; 0 <= p; --p) i[p] && !o && (r += 1, s < (l += i[p].swiperSlideSize) && (o = !0))
                } else
                    for (var c = n + 1; c < i.length; c += 1) a[c] - a[n] < s && (r += 1);
                return r
        ...
        P = {
            update: function(e) {
                var t = this,
                    ...
                    m = d.offset;
                t.updateActiveIndex();
                var v, g, w, y = t.activeIndex || 0;
                v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", w = n ? (g = Math.floor(a / 2) + s + o, Math.floor(a / 2) + s + l) : (g = a + (s - 1) + o, s + l);
                ...
                if (ee.extend(t.virtual, {
                    ...
                    }), p === b && c === x && !e) return t.slidesGrid !== h && C !== m && t.slides.css(v, C + "px"), void t.updateProgress();
                if (t.params.virtual.renderExternal) return t.params.virtual.renderExternal.call(t, {
                    offset: C,
                    from: b,
                    to: x,
                    slides: function() {
                        for (var e = [], t = b; t <= x; t += 1) e.push(u[t]);
                        return e
                    }()
                }), void E();
                var T = [],
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var M = p; M <= c; M += 1)(M < b || x < M) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
                for (var k = 0; k < u.length; k += 1) b <= k && k <= x && (void 0 === c || e ? S.push(k) : (c < k && S.push(k), k < p && T.push(k)));
            ...
            renderSlide: function(e, t) {
                ...
                var s = a.renderSlide ? L(a.renderSlide.call(i, e, t)) : L('<div class="' + i.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>");
            ...
            removeSlide: function(e) {
                ...
                if (null != e) {
                    var i = t.activeIndex;
                    if (Array.isArray(e))
                        for (var a = e.length - 1; 0 <= a; --a) t.virtual.slides.splice(e[a], 1), t.params.virtual.cache && delete t.virtual.cache[e[a]], e[a] < i && --i, i = Math.max(i, 0);
        ...
        O = {
            ...
            enable: function() {
                ...
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = L(e.params.mousewheel.eventsTarged)), t.on("mouseenter", e.mousewheel.handleMouseEnter), t.on("mouseleave", e.mousewheel.handleMouseLeave), t.on(O.event, e.mousewheel.handle), e.mousewheel.enabled = !0
            },
            disable: function() {
                var e = this;
                if (!O.event) return !1;
                if (!e.mousewheel.enabled) return !1;
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = L(e.params.mousewheel.eventsTarged)), t.off(O.event, e.mousewheel.handle), !(e.mousewheel.enabled = !1)
            }
        },
        D = {
            update: function() {
        ...
        H = {
            update: function() {
                ...
                if (s.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    var n, i = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length,
                        a = e.pagination.$el,
                        r = e.params.loop ? Math.ceil((i - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length;
                    if (e.params.loop ? ((n = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > i - 1 - 2 * e.loopedSlides && (n -= i - 2 * e.loopedSlides), r - 1 < n && (n -= r), n < 0 && "bullets" !== e.params.paginationType && (n = r + n)) : n = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && 0 < e.pagination.bullets.length) {
                        var o, l, d, p = e.pagination.bullets;
                        if (s.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (s.dynamicMainBullets + 4) + "px"), 1 < s.dynamicMainBullets && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += n - e.previousIndex, e.pagination.dynamicBulletIndex > s.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = s.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), o = n - e.pagination.dynamicBulletIndex, d = ((l = o + (Math.min(p.length, s.dynamicMainBullets) - 1)) + o) / 2), p.removeClass(s.bulletActiveClass + " " + s.bulletActiveClass + "-next " + s.bulletActiveClass + "-next-next " + s.bulletActiveClass + "-prev " + s.bulletActiveClass + "-prev-prev " + s.bulletActiveClass + "-main"), 1 < a.length) p.each(function(e, t) {
                            var i = L(t),
                                a = i.index();
                            a === n && i.addClass(s.bulletActiveClass), s.dynamicBullets && (o <= a && a <= l && i.addClass(s.bulletActiveClass + "-main"), a === o && i.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"), a === l && i.next().addClass(s.bulletActiveClass + "-next").next().addClass(s.bulletActiveClass + "-next-next"))
                        });
                        else if (p.eq(n).addClass(s.bulletActiveClass), s.dynamicBullets) {
                            for (var c = p.eq(o), u = p.eq(l), h = o; h <= l; h += 1) p.eq(h).addClass(s.bulletActiveClass + "-main");
                            c.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"), u.next().addClass(s.bulletActiveClass + "-next").next().addClass(s.bulletActiveClass + "-next-next")
                        }
                        if (s.dynamicBullets) {
                            var f = Math.min(p.length, s.dynamicMainBullets + 4),
                                m = (e.pagination.bulletSize * f - e.pagination.bulletSize) / 2 - d * e.pagination.bulletSize,
                                v = t ? "right" : "left";
                            p.css(e.isHorizontal() ? v : "top", m + "px")
                        }
                    }
                    if ("fraction" === s.type && (a.find("." + s.currentClass).text(s.formatFractionCurrent(n + 1)), a.find("." + s.totalClass).text(s.formatFractionTotal(r))), "progressbar" === s.type) {
                        ...
                        var w = (n + 1) / r,
                            y = 1,
                            b = 1;
                        "horizontal" == g ? y = w : b = w, a.find("." + s.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + y + ") scaleY(" + b + ")").transition(e.params.speed)
                    }
        ...
        B = {
            ...
            updateSize: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    var s, n = e.isHorizontal() ? a[0].offsetWidth : a[0].offsetHeight,
                        ...
                        o = r * (n / e.size);
                    s = "auto" === e.params.scrollbar.dragSize ? n * r : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? i[0].style.width = s + "px" : i[0].style.height = s + "px", a[0].style.display = 1 <= r ? "none" : "", e.params.scrollbar.hide && (a[0].style.opacity = 0), ee.extend(t, {
                        trackSize: n,
                        divider: r,
                        moveDivider: o,
                        dragSize: s
            ...
            disableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    te.touch ? (n.removeEventListener(i.start, e.scrollbar.onDragStart, r), n.removeEventListener(i.move, e.scrollbar.onDragMove, r), n.removeEventListener(i.end, e.scrollbar.onDragEnd, o)) : (n.removeEventListener(a.start, e.scrollbar.onDragStart, r), m.removeEventListener(a.move, e.scrollbar.onDragMove, r), m.removeEventListener(a.end, e.scrollbar.onDragEnd, o))
                }
            },
            init: function() {
                var e = this;
                if (e.params.scrollbar.el) {
                    ...
                    0 === n.length && (n = L('<div class="' + e.params.scrollbar.dragClass + '"></div>'), s.append(n)), ee.extend(t, {
                        $el: s,
                        el: s[0],
                        $dragEl: n,
                        dragEl: n[0]
        ...
        N = {
            setTransform: function(e, t) {
                ...
                if (null == l) a.transform("translate3d(" + r + ", " + o + ", 0px)");
                    ...
                    a.transform("translate3d(" + r + ", " + o + ", 0px) scale(" + c + ")")
                }
            },
            setTranslate: function() {
                var a = this,
                ...
                e.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
                    ...
                    var i = t.progress;
                    1 < a.params.slidesPerGroup && "auto" !== a.params.slidesPerView && (i += Math.ceil(e / 2) - s * (n.length - 1)), i = Math.min(Math.max(i, -1), 1), L(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
        ...
        G = {
            ...
            onGestureStart: function(e) {
                var t = this,
                    ...
                    a = t.zoom,
                    s = a.gesture;
                if (a.fakeGestureTouched = !1, a.fakeGestureMoved = !1, !te.gestures) {
            ...
            onGestureChange: function(e) {
                ...
                a.$imageEl && 0 !== a.$imageEl.length && (i.scale = te.gestures ? e.scale * i.currentScale : a.scaleMove / a.scaleStart * i.currentScale, i.scale > a.maxRatio && (i.scale = a.maxRatio - 1 + Math.pow(i.scale - a.maxRatio + 1, .5)), i.scale < t.minRatio && (i.scale = t.minRatio + 1 - Math.pow(t.minRatio - i.scale + 1, .5)), a.$imageEl.transform("translate3d(0,0,0) scale(" + i.scale + ")"))
            },
                    ...
                    !c.hasClass(p.elementClass) || c.hasClass(p.loadedClass) || c.hasClass(p.loadingClass) || (t = t.add(c[0])), 0 !== t.length && t.each(function(e, t) {
                        ...
                        d.loadImage(a[0], n || s, r, o, !1, function() {
                            if (null != d && d && (!d || d.params) && !d.destroyed) {
                                if (s ? (a.css("background-image", 'url("' + s + '")'), a.removeAttr("data-background")) : (r && (a.attr("srcset", r), a.removeAttr("data-srcset")), o && (a.attr("sizes", o), a.removeAttr("data-sizes")), n && (a.attr("src", n), a.removeAttr("data-src"))), a.addClass(p.loadedClass).removeClass(p.loadingClass), c.find("." + p.preloaderClass).remove(), d.params.loop && l) {
            ...
            load: function() {
                ...
                if (r.loadPrevNext)
                    if (1 < o || r.loadPrevNextAmount && 1 < r.loadPrevNextAmount) {
                        for (var c = r.loadPrevNextAmount, u = o, h = Math.min(e + u + Math.max(c, u), s.length), f = Math.max(e - Math.max(u, c), 0), m = e + o; m < h; m += 1) l(m) && a.lazy.loadInSlide(m);
                        for (var v = f; v < e; v += 1) l(v) && a.lazy.loadInSlide(v)
                    } else {
                        var g = t.children("." + i.slideNextClass);
                        0 < g.length && a.lazy.loadInSlide(d(g));
                        var w = t.children("." + i.slidePrevClass);
                        0 < w.length && a.lazy.loadInSlide(d(w))
                    }
            }
        },
        V = {
            ...
            setTranslate: function(e, t) {
                ...
                if (Array.isArray(n))
                    for (var o = 0; o < n.length; o += 1) n[o] !== t && n[o] instanceof x && r(n[o]);
            ...
            setTransition: function(t, e) {
                ...
                if (Array.isArray(s))
                    for (i = 0; i < s.length; i += 1) s[i] !== e && s[i] instanceof x && n(s[i]);
        ...
        X = {
            init: function() {
                ...
                if (e.params.history) {
                    ...
                    var t = e.history;
                    t.initialized = !0, t.paths = X.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || J.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function() {
            ...
            setHistory: function(e, t) {
                if (this.history.initialized && this.params.history.enabled) {
                    ...
                    s && s.value === a || (this.params.history.replaceState ? J.history.replaceState({
                        value: a
                    }, null, a) : J.history.pushState({
                        value: a
                    }, null, a))
                }
            },
            ...
            scrollToSlide: function(e, t, i) {
                ...
                if (t)
                    for (var s = 0, n = a.slides.length; s < n; s += 1) {
                        var r = a.slides.eq(s);
                        if (X.slugify(r.attr("data-history")) === t && !r.hasClass(a.params.slideDuplicateClass)) {
                            var o = r.index();
                            a.slideTo(o, e, i)
                        }
        ...
        j = {
            setTranslate: function() {
                var e, t = this,
                    ...
                    u = 0;
                d.shadow && (p ? (0 === (e = a.find(".swiper-cube-shadow")).length && (e = L('<div class="swiper-cube-shadow"></div>'), a.append(e)), e.css({
                    height: n + "px"
                ...
                for (var h = 0; h < s.length; h += 1) {
                    ...
                    var w = Math.max(Math.min(f[0].progress, 1), -1),
                        ...
                        b = 0,
                        x = 0;
                    m % 4 == 0 ? (y = 4 * -g * l, x = 0) : (m - 1) % 4 == 0 ? (y = 0, x = 4 * -g * l) : (m - 2) % 4 == 0 ? (y = l + 4 * g * l, x = l) : (m - 3) % 4 == 0 && (y = -l, x = 3 * l + 4 * l * g), o && (y = -y), p || (b = y, y = 0);
                    var C = "rotateX(" + (p ? 0 : -v) + "deg) rotateY(" + (p ? v : 0) + "deg) translate3d(" + y + "px, " + b + "px, " + x + "px)";
                    if (w <= 1 && -1 < w && (u = 90 * m + 90 * w, o && (u = 90 * -m - 90 * w)), f.transform(C), d.slideShadows) {
                        var E = p ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"),
                            T = p ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");
                        0 === E.length && (E = L('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), f.append(E)), 0 === T.length && (T = L('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), f.append(T)), E.length && (E[0].style.opacity = Math.max(-w, 0)), T.length && (T[0].style.opacity = Math.max(w, 0))
                    }
                }
                if (a.css({
                    ...
                    if (p) e.transform("translate3d(0px, " + (n / 2 + d.shadowOffset) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + d.shadowScale + ")");
                    else {
                ...
                var I = $.isSafari || $.isUiWebView ? -l / 2 : 0;
                a.transform("translate3d(0px,0," + I + "px) rotateX(" + (t.isHorizontal() ? 0 : u) + "deg) rotateY(" + (t.isHorizontal() ? -u : 0) + "deg)")
            },
            setTransition: function(e) {
                var t = this.$el;
            ...
            setTranslate: function() {
                for (var e = this, t = e.slides, i = e.rtlTranslate, a = 0; a < t.length; a += 1) {
                    ...
                    var r = -180 * n,
                        ...
                        d = 0;
                    if (e.isHorizontal() ? i && (r = -r) : (d = l, o = -r, r = l = 0), s[0].style.zIndex = -Math.abs(Math.round(n)) + t.length, e.params.flipEffect.slideShadows) {
                        var p = e.isHorizontal() ? s.find(".swiper-slide-shadow-left") : s.find(".swiper-slide-shadow-top"),
                            c = e.isHorizontal() ? s.find(".swiper-slide-shadow-right") : s.find(".swiper-slide-shadow-bottom");
                        0 === p.length && (p = L('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'), s.append(p)), 0 === c.length && (c = L('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(c)), p.length && (p[0].style.opacity = Math.max(-n, 0)), c.length && (c[0].style.opacity = Math.max(n, 0))
                    }
        ...
        K = {
            setTranslate: function() {
                for (var e = this, t = e.width, i = e.height, a = e.slides, s = e.$wrapperEl, n = e.slidesSizesGrid, r = e.params.coverflowEffect, o = e.isHorizontal(), l = e.translate, d = o ? t / 2 - l : i / 2 - l, p = o ? r.rotate : -r.rotate, c = r.depth, u = 0, h = a.length; u < h; u += 1) {
                    var f = a.eq(u),
                        m = n[u],
                        ...
                        b = o ? 0 : r.stretch * v,
                        x = o ? r.stretch * v : 0;
                    Math.abs(x) < .001 && (x = 0), Math.abs(b) < .001 && (b = 0), Math.abs(y) < .001 && (y = 0), Math.abs(g) < .001 && (g = 0), Math.abs(w) < .001 && (w = 0);
                    var C = "translate3d(" + x + "px," + b + "px," + y + "px)  rotateX(" + w + "deg) rotateY(" + g + "deg)";
                    if (f.transform(C), f[0].style.zIndex = 1 - Math.abs(Math.round(v)), r.slideShadows) {
                        ...
                        0 === E.length && (E = L('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'), f.append(E)), 0 === T.length && (T = L('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'), f.append(T)), E.length && (E[0].style.opacity = 0 < v ? v : 0), T.length && (T[0].style.opacity = 0 < -v ? -v : 0)
                    }
            ...
            onThumbClick: function() {
                ...
                if (t) {
                    var i = t.clickedIndex,
                        a = t.clickedSlide;
                    if (!(a && L(a).hasClass(e.params.thumbs.slideThumbActiveClass) || null == i)) {
                        var s;
                        if (s = t.params.loop ? parseInt(L(t.clickedSlide).attr("data-swiper-slide-index"), 10) : i, e.params.loop) {
                            var n = e.activeIndex;
                            e.slides.eq(n).hasClass(e.params.slideDuplicateClass) && (e.loopFix(), e._clientLeft = e.$wrapperEl[0].clientLeft, n = e.activeIndex);
                            var r = e.slides.eq(n).prevAll('[data-swiper-slide-index="' + s + '"]').eq(0).index(),
                                o = e.slides.eq(n).nextAll('[data-swiper-slide-index="' + s + '"]').eq(0).index();
                            s = void 0 === r || void 0 !== o && o - n < n - r ? o : r
                        }
                        e.slideTo(s)
                    }
                }
            ...
            update: function(e) {
                ...
                if (i) {
                    ...
                    if (1 < t.params.slidesPerView && !t.params.centeredSlides && (l = t.params.slidesPerView), i.slides.removeClass(d), i.params.loop)
                        for (var p = 0; p < l; p += 1) i.$wrapperEl.children('[data-swiper-slide-index="' + (t.realIndex + p) + '"]').addClass(d);
                    else
            ...
            on: {
                ...
                click: function(e) {
                    var t, i = this,
                        ...
                        s = a.$nextEl,
                        n = a.$prevEl;
                    !i.params.navigation.hideOnClick || L(e.target).is(n) || L(e.target).is(s) || (s ? t = s.hasClass(i.params.navigation.hiddenClass) : n && (t = n.hasClass(i.params.navigation.hiddenClass)), !0 === t ? i.emit("navigationShow", i) : i.emit("navigationHide", i), s && s.toggleClass(i.params.navigation.hiddenClass), n && n.toggleClass(i.params.navigation.hiddenClass))
                }
            }
        }, {
            name: "pagination",
...
function() {
    ...
    function t(e) {
        ...
        this.key = "waypoint-" + i, this.options = t.Adapter.extend({}, t.defaults, e), this.element = this.options.element, this.adapter = new t.Adapter(this.element), this.callback = e.handler, this.axis = this.options.horizontal ? "horizontal" : "vertical", this.enabled = this.options.enabled, this.triggerPoint = null, this.group = t.Group.findOrCreate({
            ...
            axis: this.axis
        }), this.context = t.Context.findOrCreateByElement(this.options.context), t.offsetAliases[this.options.offset] && (this.options.offset = t.offsetAliases[this.options.offset]), this.group.add(this), this.context.add(this), n[this.key] = this, i += 1
    }
    var i = 0,
        n = {};
...
function() {
    ...
    function i(e) {
        this.element = e, this.Adapter = v.Adapter, this.adapter = new this.Adapter(e), this.key = "waypoint-context-" + a, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            x: this.adapter.scrollLeft(),
            y: this.adapter.scrollTop()
        }, this.waypoints = {
            vertical: {},
            horizontal: {}
        }, e.waypointContextKey = this.key, s[e.waypointContextKey] = this, a += 1, v.windowContext || (v.windowContext = !0, v.windowContext = new i(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
    }
    var a = 0,
        s = {},
        v = window.Waypoint,
    ...
    i.prototype.add = function(e) {
        ...
        this.adapter.on("scroll.waypoints", function() {
            t.didScroll && !v.isTouch || (t.didScroll = !0, v.requestAnimationFrame(e))
        })
        ...
        for (var i in t) {
            ...
            for (var n in this.waypoints[i]) {
                ...
                if (null !== r.triggerPoint) {
                    var o = a.oldScroll < r.triggerPoint,
        ...
        for (var s in this.handleScroll(), e = {
            ...
            for (var r in this.waypoints[s]) {
                var o, l, d, p, c = this.waypoints[s][r],
                    u = c.options.offset,
                    h = c.triggerPoint,
                    f = 0,
                    m = null == h;
                c.element !== c.element.window && (f = c.adapter.offset()[n.offsetProp]), "function" == typeof u ? u = u.apply(c) : "string" == typeof u && (u = parseFloat(u), -1 < c.options.offset.indexOf("%") && (u = Math.ceil(n.contextDimension * u / 100))), o = n.contextScroll - n.contextOffset, c.triggerPoint = Math.floor(f + o - u), l = h < n.oldScroll, d = c.triggerPoint >= n.oldScroll, p = !l && !d, !m && (l && d) ? (c.queueTrigger(n.backward), a[c.group.id] = c.group) : (!m && p || m && n.oldScroll >= c.triggerPoint) && (c.queueTrigger(n.forward), a[c.group.id] = c.group)
            }
        }
...
function() {
    ...
    t.prototype.add = function(e) {
        ...
        var t = a.Adapter.inArray(e, this.waypoints); - 1 < t && this.waypoints.splice(t, 1)
...
function() {
    ...
    function e(a) {
        return function() {
            var t = [],
                i = arguments[0];
            return a.isFunction(arguments[0]) && ((i = a.extend({}, arguments[1])).handler = arguments[0]), this.each(function() {
                var e = a.extend({}, i, {
                    element: this
                });
...
function() {
    ...
    p.prototype.extend = function(e, t) {
        ...
        return e
    }, p.prototype.isMobile = function(e) {
        return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e)
    }, p.prototype.createEvent = function(e, t, i, a) {
        var s;
        return null == t && (t = !1), null == i && (i = !1), null == a && (a = null), null != document.createEvent ? (s = document.createEvent("CustomEvent")).initCustomEvent(e, t, i, a) : null != document.createEventObject ? (s = document.createEventObject()).eventType = e : s.eventName = e, s
    }, p.prototype.emitEvent = function(e, t) {
        return null != e.dispatchEvent ? e.dispatchEvent(t) : t in (null != e) ? e[t]() : "on" + t in (null != e) ? e["on" + t]() : void 0
    }, p.prototype.addEvent = function(e, t, i) {
        return null != e.addEventListener ? e.addEventListener(t, i, !1) : null != e.attachEvent ? e.attachEvent("on" + t, i) : e[t] = i
    }, p.prototype.removeEvent = function(e, t, i) {
        return null != e.removeEventListener ? e.removeEventListener(t, i, !1) : null != e.detachEvent ? e.detachEvent("on" + t, i) : delete e[t]
    }, p.prototype.innerHeight = function() {
        return "innerHeight" in window ? window.innerHeight : document.documentElement.clientHeight
    }, e = p, i = this.WeakMap || this.MozWeakMap || (d.prototype.get = function(e) {
        var t, i, a, s;
        for (t = i = 0, a = (s = this.keys).length; i < a; t = ++i)
            if (s[t] === e) return this.values[t]
    }, d.prototype.set = function(e, t) {
        var i, a, s, n;
        for (i = a = 0, s = (n = this.keys).length; a < s; i = ++a)
            if (n[i] === e) return void(this.values[i] = t);
        return this.keys.push(e), this.values.push(t)
    }, d), a = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (o.notSupported = !0, o.prototype.observe = function() {}, o), l = this.getComputedStyle || function(i, e) {
        ...
        if (this.stopped = !1, this.boxes = function() {
                var e, t, i, a;
                for (a = [], e = 0, t = (i = this.element.querySelectorAll("." + this.config.boxClass)).length; e < t; e++) s = i[e], a.push(s);
                return a
            }.call(this), this.all = function() {
                var e, t, i, a;
                for (a = [], e = 0, t = (i = this.boxes).length; e < t; e++) s = i[e], a.push(s);
                return a
            }.call(this), this.boxes.length)
            if (this.disabled()) this.resetStyle();
            else
                for (e = 0, t = (i = this.boxes).length; e < t; e++) s = i[e], this.applyStyle(s, !0);
        return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new a((r = this, function(e) {
            var t, i, s, n, a;
            for (a = [], t = 0, i = e.length; t < i; t++) n = e[t], a.push(function() {
                var e, t, i, a;
                for (a = [], e = 0, t = (i = n.addedNodes || []).length; e < t; e++) s = i[e], a.push(this.doSync(s));
                return a
            }.call(r));
            return a
        ...
        if (null == e && (e = this.element), 1 === e.nodeType) {
            for (n = [], i = 0, a = (s = (e = e.parentNode || e).querySelectorAll("." + this.config.boxClass)).length; i < a; i++) t = s[i], r.call(this.all, t) < 0 ? (this.boxes.push(t), this.all.push(t), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(t, !0), n.push(this.scrolled = !0)) : n.push(void 0);
            return n
        }
        ...
        var i, a, s, n;
        return a = e.getAttribute("data-wow-duration"), i = e.getAttribute("data-wow-delay"), s = e.getAttribute("data-wow-iteration"), this.animate((n = this, function() {
        ...
        var e, t, i, a, s;
        for (s = [], t = 0, i = (a = this.boxes).length; t < i; t++) e = a[t], s.push(e.style.visibility = "visible");
        return s
    ...
    }, n.prototype.customStyle = function(e, t, i, a, s) {
    ...
    }, n.prototype.vendors = ["moz", "webkit"], n.prototype.vendorSet = function(s, e) {
        var n, t, r, o;
        for (n in t = [], e) r = e[n], s["" + n] = r, t.push(function() {
            var e, t, i, a;
            for (a = [], e = 0, t = (i = this.vendors).length; e < t; e++) o = i[e], a.push(s["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = r);
            return a
        }.call(this));
        return t
    }, n.prototype.vendorCSS = function(e, t) {
        var i, a, s, n, r, o;
        for (n = (r = l(e)).getPropertyCSSValue(t), i = 0, a = (s = this.vendors).length; i < a; i++) o = s[i], n = n || r.getPropertyCSSValue("-" + o + "-" + t);
        return n
        ...
        return !this.scrolled || (this.scrolled = !1, this.boxes = function() {
            var e, t, i, a;
            for (a = [], e = 0, t = (i = this.boxes).length; e < t; e++)(s = i[e]) && (this.isVisible(s) ? this.show(s) : a.push(s));
            return a
        ...
        var t, i, a, s, n;
        return i = e.getAttribute("data-wow-offset") || this.config.offset, s = (n = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - i, t = (a = this.offsetTop(e)) + e.clientHeight, a <= s && n <= t
